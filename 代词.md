...
- `some`：肯定句，表示几个、一些某个疑问句，表示建议、请求希望可以修饰可数名词或者不可数名词
1. `I have some problems(我有一些问题)`
2. `Do you want to get some drinks?(你想喝点什么？)`
- `any`：肯定句，表示任何的，疑问句或者否定句，表示任何一些、任何一个可以修饰可数名词或者不可数名词
1. `I don't get any question.(我没有遇到任何的问题？)`
2. `Do you have any drinks?(你有任何喝的吗？)`

#### 8.2 no和none的区别
#### 8.3 every和each的区别
#### 8.4 either和neither的区别
#### 8.5 other和the other和another的区别
#### 8.6 others和the others的区别
#### 8.7 many和much的区别
#### 8.8 none和no one 、nobody的区别
#### 8.9 few和a few和little和a little的区别
